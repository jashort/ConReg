...
<script type="text/javascript">
function validate(){
    if((document.bid.id.value == "") & (document.bid.ln.value == "") & (document.bid.fn.value == ""))
    {
...
<!--  <form name="bid" action="/prereg_pages/prereg_checkin_list.php" method="get" target="_self">
    <fieldset id="list_table_search">
      <label>Badge Number : </label><input name="id" type="text" class="input_20_200" />
      <input name="Submit" type="submit" class="submit_button" value="Search" onmousedown="validate();" />
