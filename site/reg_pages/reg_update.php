...
if (isset($_GET['id'])) {
...
} elseif (isset($_POST["Update"]) || isset($_POST["Reprint"])) {
    ...
    if (isset($_POST["action"]) && $_POST["action"] != "reprint") {
        redirect("/index.php");
    }
}
?>
...
<head>
  ...
  <script type="text/javascript">
    ...
    // When reprint button is clicked, update the hidden field "action"
    function reprintClicked() {
      $('#action').val("reprint");
    }

    // When update button is clicked, update the hidden field "action"
  ...
  <!-- Main component for a primary marketing message or call to action -->
    <div class="jumbotron">
        ...
        <?php if (isset($_POST["action"]) && $_POST["action"] == "reprint") { ?>
            <div class="row">
                <div class="col-sm-2">
                    <form action="badgereprint.php" method="post" class="form-horizontal" target="_blank">
                        <input type="hidden" name="print" value="<?php echo $attendee->id?>" />
                        <input type="submit" name="submit" class="btn btn-primary" value="Reprint Badge" />
                    </form>
                </div>
                <div class="col-sm-2">
            ...
            <form name="reg_update" action="reg_update.php" method="post" class="form-horizontal">
                ...
                <fieldset id="personalinfo">
                    ...
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-5">
                            <input type="number" class="form-control two-character" maxlength="2" name="birth_month"
                                   id="Birth Month" value="<?php echo $attendee->getBirthMonth() ?>" min="1" max="12"
                                   placeholder="MM">
                            <span class="bold_text">/</span>
                            <input type="number" class="form-control two-character" maxlength="2" name="birth_day"
                                   id="Birth Day" value="<?php echo $attendee->getBirthDay() ?>" min="1" max="31"
                                   placeholder="DD">
                            <span class="bold_text">/</span>
                            <input type="number" class="form-control four-character" maxlength="4" name="birth_year"
                                   id="Birth Year" value="<?php echo $attendee->getBirthYear() ?>" min="1900" max="2030"
                                   placeholder="YYYY">
                            (Month / Day / Year)
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="parent_fullname" id="PCFullName" type="text" class="form-control" maxlength="250"
                                       value="<?php echo $attendee->parent_fullname ?>" />
                            </div>
                        </div>
